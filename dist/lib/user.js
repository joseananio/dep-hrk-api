...
(function (factory) {
    ...
    var getUserIdentifier = function (user) {
        return user.sub || user.email || getRandomIdentifier();
    };
    exports.getUserIdentifier = getUserIdentifier;
    var getRandomIdentifier = function () { return Math.random().toString().substr(2); };
    var getUserIdFromSocket = function (socket) { return __awaiter(void 0, void 0, void 0, function () {
